                                ...
                                <tbody class="order-list">
                                    ...
                                    @foreach ($order->products as $product )
                                        ...
                                        <tr>
                                            ...
                                            <td><input type='number' class="form-controal input-sm product-quantity" data-price="{{number_format($product->sale_price,2)}}" min="1" value="{{ $product->pivot->quantity }}" name =" products[{{$product->id  }}][quantity]" ></td>
